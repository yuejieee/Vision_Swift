...
extension MHPlayerBottomMenu {
    ...
    override func layoutSubviews() {
        ...
        playOrPauseBtn.frame = CGRect(x: self.left + 20, y: 8, width: 25, height: 25)
        if mhFull == true {
        ...
        timeLabel.frame = CGRect(x: fullOrSmallBtn.left - 80, y: 10, width: 108, height: 20)
        loadProgressView.frame = CGRect(x: playOrPauseBtn.right + nextPlayerBtn.width, y: 20, width: timeLabel.left - playOrPauseBtn.right - nextPlayerBtn.width - 14, height: 20)
